      ...
      <div>
        <div className="flex flex-wrap items-center justify-between mx-auto p-2">
          ...
          </motion.div>
          {
            !nav
            ?
            <button onClick={handleClick} className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul className="font-medium flex flex-row space-x-8 list-none dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
