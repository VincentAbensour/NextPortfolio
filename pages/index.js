  ...
  return (
    ...
    <div id="content" className='w-4/5 m-auto xl:w-4/6'>
            ...
            <div className='self-center flex flex-col'>
                ...
                <Link href="#about-section" className="self-center" scroll={false}>
                    <motion.div animate={{y:0, opacity:1}} initial={{y:20, opacity:0}} transition={{ease: 'easeInOut', duration:0.5, delay:1.8}}>
                        <Image src="/icons/triangle.png" width={50} height={50} className='duration-300 ease-in-out hover:translate-y-4'></Image>
                    </motion.div>
                </Link>
            </div>
          </div>
        ...
        <section id="projects-section" className='my-8'>
            ...
            <div className='bg-custombluegrey rounded-sm p-2 my-12 mx-auto w-4/5 max-w-xs md:bg-transparent md:max-w-5xl md:w-full md:grid md:grid-cols-12 md:mt-8'>
                <div className='relative hidden md:grid col-start-1 col-end-8 row-span-full self-center grayscale z-0 hover:z-20 hover:grayscale-0' >
                    <img src="/projects/chat-login.png" className={`row-span-full col-span-full + ${countChat === 1 ? "block" : "hidden"}`}/>
                    <img src="/projects/chat-register.png" className={`row-span-full col-span-full + ${countChat === 2 ? "block" : "hidden"}`}/>
                    <img src="/projects/chat-home.png" className={`row-span-full col-span-full + ${countChat === 3 ? "block" : "hidden"}`}/>
                    <img src="/icons/next.png" onClick={handleClickChat} className='absolute z-30 w-6 cursor-pointer my-auto top-0 bottom-0 right-0'></img>
                </div>
        ...
        <div className='bg-custombluegrey rounded-sm p-2 my-4 mx-auto w-4/5 max-w-xs md:bg-transparent md:max-w-5xl md:w-full md:grid md:grid-cols-12 md:mt-8'>
            ...
            <div className='relative hidden md:grid col-start-1 col-end-8 row-span-full self-center grayscale z-0 hover:z-20 hover:grayscale-0' >
                <img src="/projects/ecom-home.png" className={`row-span-full col-span-full + ${countEcom === 1 ? "block" : "hidden"}`}/>
                <img src="/projects/ecom-cart.png" className={`row-span-full col-span-full + ${countEcom === 2 ? "block" : "hidden"}`}/>
                <img src="/projects/ecom-market.png" className={`row-span-full col-span-full + ${countEcom === 3 ? "block" : "hidden"}`}/>
                <img src="/icons/blacknext.png" onClick={handleClickEcom} className='absolute z-30 w-10 cursor-pointer my-auto top-0 bottom-0 right-0'></img>
            </div>
            ...
            <h2 class="text-customtexthighlight my-5">Let's get in Touch!</h2>
              ...
              <div class="mt-8 flex flex-col self-center">
                ...
                <div className='flex self-center mt-4'>
                  <a href="https://www.linkedin.com/in/vincent-abensour-0a477a176/">
                    <Image width={40} height={40} src="/icons/linkedin-icon.png" alt="github-icon"></Image>
                  </a>
                  <a href="https://github.com/VincentAbensour">
                    <Image width={40} height={40} src="/icons/github-icon.png" alt="github-icon"></Image>
                  </a>
                </div>
              </div>
